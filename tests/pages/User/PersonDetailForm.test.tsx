//Aqui, verificamos o tipo, o espaço reservado, o rótulo dos campos de entrada, bem como o tipo e o texto do botão.
...
describe("<PersonalDetailForm />", () => {
  ...
  //!simulamos cada entrada e verificamos se a parte da validação e o texto da validação funcionam ou não.
