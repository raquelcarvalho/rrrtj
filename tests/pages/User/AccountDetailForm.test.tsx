...
describe("<AccountDetailForm />", () => {
  ...
  describe("defines account detail form fields", () => {
    it("renders account number field", () => {
      ...
      expect(userAccountNumberField.prop("placeHolder")).toBe(
    ...
    it("renders previous button", () => {
      const previousButton = wrapper.find("Button").at(0).dive();
  ...
  describe("form validation", () => {
    ...
    describe("input#account number", () => {
      ...
      beforeEach(() => {
        accountNumberField = wrapper
          .find('input[name="useraccountNumber"]')
          .first();
      });
